...
class CollisionDetector:
    ...
    def will_collide_with_border(self, current_location: Location, orientation: str):
        def is_facing_northern_grid_border() -> bool:
            return orientation == Orientations.N.name and current_location.y >= self.__grid_size
        ...
        def is_facing_eastern_grid_border() -> bool:
            return orientation == Orientations.E.name and current_location.x >= self.__grid_size
